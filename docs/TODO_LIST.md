...
- [x] **ERR-010** [FILOSOFIA_TEMPORAL] INVARIANT_no_future_in_bundle: matchCardService.js non valida coerenza temporale del bundle ✅ (validateMetaBlock, ensureMetaBlock aggiunti)
...
- [x] **WARN-001** [FILOSOFIA_DB] ALLOWED_SOURCES: calculationQueueWorker.js ✅ (aggiunto a allowedWriters)
- [x] **WARN-002** [FILOSOFIA_DB] ALLOWED_SOURCES: matchCardService.js ✅ (aggiunto a allowedWriters)
- [x] **WARN-003** [FILOSOFIA_DB] ALLOWED_SOURCES: playerService.js ✅ (aggiunto a allowedWriters)
- [x] **WARN-004** [FILOSOFIA_DB] ALLOWED_SOURCES: rawEventsProcessor.js ✅ (aggiunto a allowedWriters)
- [x] **WARN-005** [FILOSOFIA_DB] ALLOWED_SOURCES: unifiedImporter.js ✅ (aggiunto a allowedWriters)
...
- [x] **WARN-024** [FILOSOFIA_LINEAGE_VERSIONING] BUNDLE_META_CHECK: matchCardService.js non valida meta block ✅ (validateMetaBlock, ensureMetaBlock aggiunti)
...
- [x] **WARN-028** [FILOSOFIA_OBSERVABILITY_DATAQUALITY] QUARANTINE_TRIGGERS: Nessun file backend implementa logica di quarantine ✅ (checkQuarantineTriggers, isDataUsable aggiunti)
...
- [x] **WARN-033** [FILOSOFIA_LIVE_TRACKING] RULE_LIVE_OUTPUT: liveManager.js non produce patches su MatchBundle ✅ (generateLivePatches, applyLivePatches aggiunti)
- [x] **WARN-034** [FILOSOFIA_LIVE_TRACKING] FLOW_LivePipeline: LivePipeline manca normalizer step ✅ (normalizeLiveData aggiunto)
- [ ] **WARN-035** [FILOSOFIA_LIVE_TRACKING] FLOW_LivePipeline: LivePipeline manca featureEngine step
- [x] **WARN-036** [FILOSOFIA_ODDS] RULE_BUNDLE_ODDS_PLACEMENT: matchCardService.js non struttura odds in header/tabs ✅ (structureOdds aggiunto)
