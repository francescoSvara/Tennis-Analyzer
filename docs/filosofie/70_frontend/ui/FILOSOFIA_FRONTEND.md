...
- [SCHEDE_UI_TAB](../../../specs/SCHEDE_UI_TAB.md) – specifiche visual design pagine e tab

### � Pseudocode

| Documento                                                              | Descrizione                 |
| ---------------------------------------------------------------------- | --------------------------- |
| [FILOSOFIA_FRONTEND_PSEUDOCODE](./FILOSOFIA_FRONTEND_PSEUDOCODE.md)    | Regole formali frontend UI  |
